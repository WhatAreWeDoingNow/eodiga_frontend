    ...
    return (
        <div css={s.container}>
            ...
            <div css={s.calender_text}>
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="3.74994" y="7.5" width="22.5" height="18.75" rx="2.5" stroke="#33363F" stroke-width="2" />
                    <path d="M4.99994 13.75H24.9999" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
                    <path d="M12.4999 20H17.4999" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
                    <path d="M15 17.5L15 22.5" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
                    <path d="M10 3.75L10 8.75" stroke="#33363F" stroke-width="2.5" stroke-linecap="round" />
                    <path d="M20 3.75L20 8.75" stroke="#33363F" stroke-width="2" stroke-linecap="round" />
                </svg>
                <p>날짜와 시간을 선택해주세요</p>
            </div>
            <Calendar />
