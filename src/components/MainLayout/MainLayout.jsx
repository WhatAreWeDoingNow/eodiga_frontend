  ...
  return (
    <div css={s.container}>
      <div css={s.layout}>
        ...
        <footer css={s.bar}>
          <div css={s.bottom_icons} onClick={() => navigate('/main/home')}>
          ...
          <div css={s.bottom_icons} onClick={() => navigate('/main/detail')}>
            {/* <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="5.00049" y="6.75" width="20" height="20" rx="2.5" stroke={location == 'detail' ? '#FF6B6B' : '#33363F'} />
              <path d="M20.0005 3L20.0005 8C20.0005 9.17851 20.0005 9.76776 19.6344 10.1339C19.2683 10.5 18.679 10.5 17.5005 10.5L12.5005 10.5C11.322 10.5 10.7327 10.5 10.3666 10.1339C10.0005 9.76777 10.0005 9.17851 10.0005 8L10.0005 3.00001" stroke={location == 'detail' ? '#FF6B6B' : '#33363F'} stroke-linecap="round" />
              <path d="M11.2505 18L18.7505 18" stroke={location == 'detail' ? '#FF6B6B' : '#33363F'} stroke-linecap="round" />
            </svg>
            <p style={{ color: location === 'detail' ? '#FF6B6B' : '' }}>가게관리</p>
          </div>
          <div css={s.bottom_icons} onClick={() => navigate('/main/reservation')}>
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div css={s.bottom_icons} onClick={() => navigate('/main/mileage')}>
            {/* <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9.99976 12.5L9.99976 20" stroke={location == 'mileage' ? '#FF6B6B' : '#33363F'} stroke-linecap="round" stroke-linejoin="round" />
              <path d="M14.9998 15V20" stroke={location == 'mileage' ? '#FF6B6B' : '#33363F'} stroke-linecap="round" stroke-linejoin="round" />
              <path d="M19.9998 10V20" stroke={location == 'mileage' ? '#FF6B6B' : '#33363F'} stroke-linecap="round" stroke-linejoin="round" />
              <rect x="3.74976" y="5" width="22.5" height="20" rx="4.58709" stroke={location == 'mileage' ? '#FF6B6B' : '#33363F'} />
            </svg>


            <p style={{ color: location === 'mileage' ? '#FF6B6B' : '' }}>마일리지</p>
          </div>
          <div css={s.bottom_icons} onClick={() => navigate('/main/my')}>
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
